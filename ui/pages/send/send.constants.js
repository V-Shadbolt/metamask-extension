...
const UNS_COMMON_ERROR = 'unsCommonError';
const UNS_UNKNOWN_ERROR = 'unsUnknownError';
const UNS_CONFUSING_ERROR = 'unsConfusingError';
const UNS_CURRENCY_SPEC_ERROR = 'unsCurrencySpecError';
const UNS_CURRENCY_ERROR = 'unsCurrencyError';
